    ...
    <>
      <footer className="relative bg-white pt-8 pb-6">
        ...
        >
          <a
            href="/"
            className="flex items-center gap-4 w-2/3 pl-4 mb-2 lg:visible lg:w-auto lg:pl-0 lg:mb-0"
          >
            <img
              width="100px"
              src={Logo}
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="flex gap-1 md:ml-10 lg:ml-10 xl:ml-10 text-sm text-gray-600 font-semibold py-1">
            <h1>Dikembangkan Oleh</h1>
            <h1 className="font-bold text-teal-600"> Fajrul.id</h1>
          </div>
        </div>
      </footer>
    </>
