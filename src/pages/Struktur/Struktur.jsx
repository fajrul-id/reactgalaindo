import "./struktur.css";
import Desktop from "../../images/struktur.png";
import Mobile from "../../images/mobile-struktur.png";
import React from "react";

const Struktur = () => {
  return (
    <section id="produk" className="relative w-full bg-gray-100 pb-32">
      <h2 className="text-4xl font-bold text-center text-gray-800 sm:mt-10 ">
        Struktur Organisasi
      </h2>
